...
<div class="content-wrapper">
   <!-- <div class="row mx-3">
      <div class="alert alert-danger alert-dismissible fade show col-lg-8 mx-auto" role="alert">
         <strong><i class="mdi mdi-alert-octagon"></i>Hi @php echo ucfirst(Auth::user()->name); @endphp</strong> Please Complete Your Profile First!
   ...
   @endif 
   <form action="{{route('admin-coach-profile-update' )}}"  enctype="multipart/form-data" id="editform2" method="post">
      {{ csrf_field() }}
      <div class="row">
            ...
            <div class="card">
               <div class="card-body row">
                  ...
                  <!-- <div class="form-group col-lg-6 md-group">
                     <label>Phone Number</label>
                     <input type="text" name="phone" value="@if(!empty($user->phone)){{old('phone', $user->phone)}}@endif"  class="form-control" id="mobile_code" placeholder="+93-xxxxxxxx" maxlength="10">
                     <div  style="color:red">{{ $errors->first('phone') }}</div>
                  </div> -->
                  <div class="form-group col-lg-6">
                     <label>Country</label>
