            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body row">
                   ...
                   <input type="text" name="title" value="{{ $Faq->title }}" class="form-control form-control-lg" id="" placeholder="Enter Title">
                   <div id="name_error" style="color:red">{{ $errors->first('title') }}</div>
                    ...
                    <select name="type" class="form-control form-control-lg">
                      ...
                      <option value="user" {{ $Faq->type == 'user' ? "selected" : "" }} class="text-dark">User</option>
                      <option value="coach" {{ $Faq->type == 'coach' ? "selected" : "" }} class="text-dark">Coach</option>
                    </select>
                   ...
                   <div id="name_error" style="color:red">{{ $errors->first('type') }}</div>
                    ...
                    <textarea name="descp" class="form-control form-control-lg" placeholder="Enter Description">{{ $Faq->descp }}</textarea>
                   ...
                   <div class="form-group col-lg-6 ">
                    <input type="hidden" name="ide" value="{{ $Faq->id }}">
