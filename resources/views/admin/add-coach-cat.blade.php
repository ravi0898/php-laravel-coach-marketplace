...
<div class="content-wrapper">
   ...
   <form method="POST" action="{{route('admin-insert-coachCat')}}" enctype="multipart/form-data" >
      {{ csrf_field() }}
      <div class="row">
                  ...
                  <div class="card-body row justify-content-center align-items-center">
                    <div>
                      <div class="search-btn-wrap">
                          <input type="text" name="categoryName" value="{{old('categoryName')}}" class="roboto discover-search-input" placeholder="Category Name">
