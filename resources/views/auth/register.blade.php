      ...
      <div class="row custom-color1">
         <div class="col-lg-7 m-auto px-0 custom-color1">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
               ...
               <h6 class="">Apply to become an advisor - It only takes a minute.</h6>
               <form method="POST" class="pt-3 row" action="{{ route('register') }}">
                  ...
                  <div class="form-group col-lg-12">
                     ...
                     <textarea id="expertise" class="form-control form-control-lg @error('expertise') is-invalid @enderror signup-textarea" name="expertise" row="6" placeholder="Let us know, what your areas of expertise are - and what expertise you have with these areas (in a few words)">{{ old('expertise') }}</textarea>
                     @error('expertise')
                     <span class="invalid-feedback" role="alert">
                     <strong>{{ $message }}</strong>
                     </span>
                  ...
                  <div class="form-group col-lg-12">
                     <label>How did you hear about Zentia?</label>
                     <textarea id="why_advisor" class="form-control form-control-lg @error('why_advisor') is-invalid @enderror signup-textarea" name="why_advisor" row="1" placeholder="On Linkedin? In the press? From your network? Somewhere else?">{{ old('why_advisor') }}</textarea>
                     @error('why_advisor')
                     <span class="invalid-feedback" role="alert">
                     <strong>{{ $message }}</strong>
                     </span>
