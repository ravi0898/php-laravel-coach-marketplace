...
<body style="background-image: linear-gradient(164deg, #000000 46%, #3e3e3e 40%);margin: 0;display: flex;justify-content: center;align-items: center;">
    <table style="width: 100%;max-width: 620px;margin: 30px auto;background-color: #ffffff;border-top: 5px solid #ff9b7b;border-radius: 4px;font-family: Arial, Helvetica, sans-serif;position: relative;box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px;" cellpadding="0" cellspacing="0">
        <tbody>
            ...
            <tr>
                <td align="center" style="text-decoration: none;line-height: 24px;font-size: 24px;padding: 0px 28px 0px 28px;color: #ff9b7b;font-weight: bold;">Hello Admin!
                </td>
             </tr>
             <tr>
                <td style="
    ...
    font-weight: 700;
    color: #099b43;
"><strong>{{ $name}} ({{$email}}) </strong>has completed his profile.</td>
             </tr>
             <tr>
                <td align="center" style="text-decoration: none; line-height: 24px; font-size: 16px; color: #676767; padding: 20px 28px;">Please go to website to review and approve the profile to visible on website!
                </td>
             </tr>
            
            <tr>
                <td align="center">
                   <a href="{{url('/admin/dashboard')}}" target="_blank" style="background: #ff9b7b;padding: 12px 30px;display: inline-block;border-radius: 4px;color: #fff;margin-bottom: 26px;font-weight: 700;text-decoration: none;font-size: 16px;font-family: arial;">Go To Website</a>
                </td>
             </tr>
             <tr>
