...
<body style="background-image: linear-gradient(164deg, #000000 46%, #3e3e3e 40%);margin: 0;display: flex;justify-content: center;align-items: center;">
    ...
    font-weight: 700;
    color: #099b43;
"><strong>Thanks! </strong>For completing the profile.</td>
             </tr>
             <tr>
                <td align="center" style="text-decoration: none; line-height: 24px; font-size: 16px; color: #676767; padding: 20px 28px;">We will notify you when your profile is approved by Zentia!
                </td>
             </tr>
             <tr>
            ...
            <tr>
                <td align="center">
                   <a href="{{url('/')}}" target="_blank" style="background: #ff9b7b;padding: 12px 30px;display: inline-block;border-radius: 4px;color: #fff;margin-bottom: 26px;font-weight: 700;text-decoration: none;font-size: 16px;font-family: arial;">Go To Website</a>
                </td>
             </tr>
             <tr>
