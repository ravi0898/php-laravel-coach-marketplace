    ...
    <table style="width: 100%;max-width: 700px; margin: 30px auto;background-color: #000;border-top: 5px solid #ff9b7b;border-radius: 4px;font-family: Arial, Helvetica, sans-serif;position: relative;box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px;" cellpadding="0" cellspacing="0">
        <tbody>
            ...
            <tr>
             ...
             <tr>
                <td style="display: block;text-align: center;padding: 28px 0 14px 0;color: #ffffff;max-width: 452px;margin: auto;font-size: 16px;line-height: 24px;">Meeting Scheduled</td>
             </tr>
             <tr>
               <td align="center" style="font-size: 18px;color: #ffffff;padding: 20px 28px;font-weight: 700;">Next steps: </td>
            </tr>
            <tr>
               <td align="center" style="font-size: 16px;color: #ffffff;line-height: 24px;padding: 14px 28px 24px 28px;width: 450px;display: block;margin: auto;"> Please go to<span style="color: #ff9a7a;"> Zentia</span> dashboard to review the meeting details.</td>
            </tr>
            <tr>
                <td align="center">
