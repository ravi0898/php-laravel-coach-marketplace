    ...
    <table style="width: 100%;max-width: 700px; margin: 30px auto;background-color: #000;border-top: 5px solid #ff9b7b;border-radius: 4px;font-family: Arial, Helvetica, sans-serif;position: relative;box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px;" cellpadding="0" cellspacing="0">
        <tbody>
            ...
            <tr>
             ...
             <tr>
                <td style="display: block;text-align: center;padding: 28px 0 14px 0;color: #ffffff;max-width: 452px;margin: auto;font-size: 16px;line-height: 24px;">Thank you so much for taking an interest <span style="color: #ff9a7a;"> Zentia</span> - and for your request to become an Advisor.</td>
             </tr>
             <tr>
               <td align="center" style="font-size: 18px;color: #ffffff;padding: 20px 28px;font-weight: 700;">Email   :  {{ $emails }}</td>
               
            </tr>
            
            <tr>
            <td align="center" style="font-size: 18px;color: #ffffff;padding: 20px 28px;font-weight: 700;">Company :  {{ $company }}</td>
            </tr>
            
            <tr>
            <td align="center" style="font-size: 18px;color: #ffffff;padding: 20px 28px;font-weight: 700;">Message :  {{ $comments }}</td>
            </tr>
            
            
            
            <tr>
               <td align="center" style="font-size: 16px;color: #ffffff;line-height: 24px;padding: 14px 28px 24px 28px;width: 450px;display: block;margin: auto;">Our team will now review your information and evaluate whether your profile and experience matches our requirements.
                  We'll let you know, once it's done.</td>
            </tr>
            <tr>
               <td align="center" style="font-size: 16px;color: #ffffff;line-height: 24px;padding: 10px 28px;width: 450px;display: block;margin: auto;">In the meantime, please sit tight!</td>
            </tr>
             <tr>
