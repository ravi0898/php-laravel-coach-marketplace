...
<head>
    ...
    <title>Your profile is now complete, thanks!</title>
    ...
    <table style="width: 100%;max-width: 700px; margin: 30px auto;background-color: #000;border-top: 5px solid #ff9b7b;border-radius: 4px;font-family: Arial, Helvetica, sans-serif;position: relative;box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px;" cellpadding="0" cellspacing="0">
        <tbody>
            ...
            <tr>
             ...
             <tr>
                <td style="display: block;text-align: center;padding: 28px 0 14px 0;color: #ffffff;max-width: 452px;margin: auto;font-size: 16px;line-height: 24px;">Yay! Your advisor profile is now complete.</td>
             </tr>
             <tr>
                <td style="display: block;text-align: center;padding: 28px 0 10px 0;color: #ffffff;max-width: 452px;margin: auto;font-size: 16px;line-height: 24px;">We’re just reviewing things one last time and in a matter of hours you’ll be up and running on the platform. We'll let you know, once that happens.</td>
             </tr>
             <tr>
                <td style="display: block;text-align: center;padding: 10px 0 14px 0;color: #ffffff;max-width: 452px;margin: auto;font-size: 16px;line-height: 24px;">If you want more news and updates from our side in general, feel free to connect with our <a href="{{ route('contact') }}"><span style="background: #cf9a44; color:black;">founder</span></a> on Linkedin.</td>
             </tr>
             <tr>
                <td style="display: block;text-align: center;padding: 28px 0 14px 0;color: #ffffff;max-width: 452px;margin: auto;font-size: 16px;line-height: 24px;">Don’t be a stranger 👋</td>
             </tr>
