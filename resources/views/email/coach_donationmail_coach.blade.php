    ...
    <table style="width: 100%;max-width: 700px; margin: 30px auto;background-color: #000;border-top: 5px solid #ff9b7b;border-radius: 4px;font-family: Arial, Helvetica, sans-serif;position: relative;box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px;" cellpadding="0" cellspacing="0">
        <tbody>
            ...
            <tr>
             ...
             <tr>
                <td style="display: block;text-align: center;padding: 28px 0 14px 0;color: #ffffff;max-width: 452px;margin: auto;font-size: 16px;line-height: 24px;">Wauw, just wauw. </br>

                                            We’re thrilled to confirm you’ve made a donation from your Zentia profile, which is going to support a noble cause. </td>
             </tr>
            ...
            We’re badging donations from our coaches and donating them to causes and charities who could use the extra support.
             </td>
             </tr>
            

             <tr>
                <td align="center" style=" text-decoration: none; line-height: 20px; font-size: 17px; padding-bottom: 10px;color: #000; font-weight: 300; ">
                If you wish to influence what cause/charity this month’s donations go to, then feel free to shoot us an email at donations@zentia.io with your suggestions.

                  </br>  Thank you for your contribution. This means a lot </br>
