...
<head>
    ...
    <title>Complete booking payment within 12 hours</title>
    ...
    <table style="width: 100%;max-width: 700px; margin: 30px auto;background-color: #000;border-top: 5px solid #ff9b7b;border-radius: 4px;font-family: Arial, Helvetica, sans-serif;position: relative;box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px;" cellpadding="0" cellspacing="0">
        <tbody>
            ...
            <tr>
             ...
             <tr>
                <td style="display: block;text-align: center;padding: 28px 0 14px 0;color: #ffffff;max-width: 452px;margin: auto;font-size: 16px;line-height: 24px;">Yay! {{ ucfirst($coachname) }} has accepted your meeting request🤗. </td>
             </tr>
             <tr>
                <td style="display: block;text-align: center;padding: 28px 0 14px 0;color: #ffffff;max-width: 452px;margin: auto;font-size: 16px;line-height: 24px;">To complete the booking, please follow this <a href="{{url('/user/booking')}}"><span style="background: #cf9a44; color:black;">link</span></a> to pay for the upcoming session. The booking must be paid within 12 hours, to successfully book the advisor. 
 </td>
             </tr>
             <tr>
                <td style="display: block;text-align: center;padding: 28px 0 14px 0;color: #ffffff;max-width: 452px;margin: auto;font-size: 16px;line-height: 24px;">You will receive a confirmation once the payment has been processed and the meeting is booked.
</td>
             </tr>
