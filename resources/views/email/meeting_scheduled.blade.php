    ...
    <table style="width: 100%;max-width: 700px; margin: 30px auto;background-color: #000;border-top: 5px solid #ff9b7b;border-radius: 4px;font-family: Arial, Helvetica, sans-serif;position: relative;box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px;" cellpadding="0" cellspacing="0">
        <tbody>
            ...
            <tr>
             ...
             <tr>
                <td style="display: block;text-align: center;padding: 28px 0 14px 0;color: #ffffff;max-width: 452px;margin: auto;font-size: 16px;line-height: 24px;">Your payment has successfully been processed, and a meeting has been booked between you and the requested advisor. </td>
             </tr>
             <tr>
                <td style="display: block;text-align: center;padding: 28px 0 14px 0;color: #ffffff;max-width: 452px;margin: auto;font-size: 16px;line-height: 24px;">You can add it to your calendar with this <a rel="noopener" target="_blank" href="https://calendar.google.com/calendar/render?action=TEMPLATE&ctz=Europe/Brussels&dates=@php echo $gm_start_date; @endphp%2F@php echo $gm_end_date; @endphp&details=To%20join%20the%20meeting%20room,%20please%20login%20to%20your%20Zentia%20account%20and%20paste%20this%20link%20into%20your%20browser:%20https%3A%2F%2Fzentia.io%2Fcallbackurl%2F@php echo $link; @endphp%0A%0AConnecting%20the%20brightest%20minds.%20Book%20digital%20one-to-one%20sessions%20with%20tier%201%20entrepreneurs%20and%20executives.&location=Zentia&text=Zentia%20Meeting" class="cta btn-yellow" ><span style="background: #cf9a44; color:black;">link</span></a>. </td>
             </tr>
            

             <tr>
                <td style="display: block;text-align: center;padding: 28px 0 14px 0;color: #ffffff;max-width: 452px;margin: auto;font-size: 16px;line-height: 24px;">When the meeting is about to take place, please follow these guidelines:</td>
             </tr>
              <tr>
                <td style="display: block;text-align: center;padding: 28px 0 5px 0;color: #ffffff;max-width: 452px;margin: auto;font-size: 16px;line-height: 24px;">1. Login to your <strong>Zentia profile</strong></td>
             </tr>
              <tr>
                <td style="display: block;text-align: center;padding: 5px 0 5px 0;color: #ffffff;max-width: 452px;margin: auto;font-size: 16px;line-height: 24px;"><span style="background: #cf9a44; color:black;">2. Click the <strong>‘Join Meeting’</strong> section, in the dashboard panel</span></td>
             </tr>
              <tr>
                <td style="display: block;text-align: center;padding: 5px 0 5px 0;color: #ffffff;max-width: 452px;margin: auto;font-size: 16px;line-height: 24px;">3. You’re now ready! 💯</td>
             </tr>
              <tr>
                <td style="display: block;text-align: center;padding: 5px 0 14px 0;color: #ffffff;max-width: 452px;margin: auto;font-size: 16px;line-height: 24px;">4. In case you wish to extend the meeting, while having it, there is an option for that as well in the call</td>
             </tr>
              <tr>
                <td style="display: block;text-align: center;padding: 28px 0 14px 0;color: #ffffff;max-width: 452px;margin: auto;font-size: 16px;line-height: 24px;">We recommend you <strong>do the meeting from your laptop</strong>. It's just the best experience for both parties, when you can see each other's smiling faces properly, you know. </td>
             </tr>
              <tr>
