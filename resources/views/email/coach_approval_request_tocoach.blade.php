    ...
    <table style="width: 100%;max-width: 700px; margin: 30px auto;background-color: #000;border-top: 5px solid #ff9b7b;border-radius: 4px;font-family: Arial, Helvetica, sans-serif;position: relative;box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px;" cellpadding="0" cellspacing="0">
        <tbody>
            ...
            <tr>
             ...
             <tr>
                <td style="display: block;text-align: center;padding: 28px 0 14px 0;color: #ffffff;max-width: 452px;margin: auto;font-size: 16px;line-height: 24px;">Thank you so much for taking an interest Zentia - and for your request to become an advisor.</td>
             </tr>
             <tr>
               <td align="center" style="font-size: 18px;color: #ffffff;padding: 20px 28px;font-weight: 700;">Next steps: </td>
            </tr>
             <tr>
                <td style="display: block;text-align: center;padding: 10px 0 10px 0;color: #ffffff;max-width: 452px;margin: auto;font-size: 16px;line-height: 24px;">Our team will now review your information and evaluate whether your profile and experience matches our requirements.</td>
             </tr>
             <tr>
                <td style="display: block;text-align: center;padding: 10px 0 5px 0;color: #ffffff;max-width: 452px;margin: auto;font-size: 16px;line-height: 24px;">We'll let you know, once it's done.</td>
             </tr>
             <tr>
                <td style="display: block;text-align: center;padding: 5px 0 30px 0;color: #ffffff;max-width: 452px;margin: auto;font-size: 16px;line-height: 24px;">In the meantime, please sit tight!</td>
             </tr>
            <tr>
