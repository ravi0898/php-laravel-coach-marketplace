    ...
    <table style="width: 100%;max-width: 700px; margin: 30px auto;background-color: #000;border-top: 5px solid #ff9b7b;border-radius: 4px;font-family: Arial, Helvetica, sans-serif;position: relative;box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px;" cellpadding="0" cellspacing="0">
        <tbody>
            ...
            <tr>
             ...
             <tr>
                <td style="display: block;text-align: center;padding: 28px 0 14px 0;color: #ffffff;max-width: 452px;margin: auto;font-size: 16px;line-height: 24px;">
                      Your money will soon be on their way to your bank account 💸 We’ve now approved your withdrawal request, and the transaction will be executed within 7 business days. 
                      This means you can look forward to receiving your earnings in your bank account very soon. Yay! 💰
                      Have a great day.
            ...
            <tr>
             ...
             <tr>
                <td align="center" style=" text-decoration: none; line-height: 20px; font-size: 17px; padding-bottom: 10px;color: #fff; font-weight: 300; ">Ps. In case you didn’t make this withdrawal request, please contact info@zentia.io for support ASAP.</td>
             </tr><tr>
