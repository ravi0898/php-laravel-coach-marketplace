...
<div class="content-wrapper">
        ...
        @else
            <div class="alert alert-dismissible fade show col-lg-8 mx-auto success-message-wrap" role="alert">
               <div class="d-flex align-items-center">
                  <p class="success-tag d-none d-sm-flex"><i class="ti-check-box menu-icon mr-2"></i>Saved</p>
                  <div class="d-flex flex-column">
                     <h4 class="message-heading text-success mb-1">Update Calendar</h4>
                     <span>Your profile is updated and saved.Please update your calender too.</span>
                  </div> 
               </div>
               <button type="button" class="close" data-dismiss="alert">&times;</button>
               </button>
    ...
    @if($user->status == '1' &&  empty($user->price_20) && empty($user->expertise) && empty($user->about_me))
        <!-- <div class="alert alert-danger alert-dismissible fade show col-lg-8 mx-auto" role="alert">
          <strong>Please update your profile. And locked categories will unlock once your profile and calendar has been approved. Thanks!</strong> 
          <button type="button" class="close" data-dismiss="alert" aria-label="Close">
          <span aria-hidden="true">&times;</span>
          </button>
        </div> -->
        <div class="alert alert-dismissible fade show col-lg-8 mx-auto error-message-wrap" role="alert">
            <div class="d-flex align-items-center">
               ...
               <p class="text-danger mr-4 mb-0">Please update your profile. And locked categories will unlock once your profile and calendar has been approved. Thanks!</p>
            </div>
            <button type="button" class="close" data-dismiss="alert">&times;</button>
         </div>
    @endif
   ...
   <div class="alert alert-dismissible fade show col-lg-8 mx-auto success-message-wrap" role="alert">
      <div class="d-flex align-items-center">
         ...
         <div class="d-flex flex-column">
            <h4 class="message-heading text-success mb-1">Profile Updated!</h4>
            <span>{{ $message }} </span>
         </div> 
      </div>
      <button type="button" class="close" data-dismiss="alert">&times;</button>
