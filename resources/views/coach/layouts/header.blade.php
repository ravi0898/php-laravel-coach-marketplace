               ...
               <ul class="navbar-nav navbar-nav-right">
                  <li class="nav-item dropdown">
                     ...
                     <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list notification-drop-menu" aria-labelledby="notificationDropdown" style="overflow-y: auto;height: 300px; " >
                        ...
                        @else
                        <a href="{{ route('change-notification-status', $id) }}"class="dropdown-item preview-item mb-2" style="background-color: #eaeaf1;">
                           <div class="preview-thumbnail">
                              <div class="preview-icon bg-gray">
                                 <i class="ti-user mx-0 text-main"></i>
                              </div>
         ...
         $('.countdownpp').each(function(){  
             ...
             // Set the date we're counting down to
                 ...
                 function padLeadingZeros(num, size) {
                   ...
                   document.getElementById(id).innerHTML = '<a href="#"  class="btn btn-primary btn-sm btn-rounded booking-status-value hover-brder btn-blue d-flex justify-content-center align-items-center" id="save-chage" style="border-radius: 5px;"><i class="ti-video-camera pr-2 text-white" style="font-size: 20px;"></i><div><span class="countdowns text-white bg-danger justify-content-center align-items-center fs-18">'+padLeadingZeros(hours, 2)+':</span><span class="countdowns text-white bg-danger  justify-content-center align-items-center fs-18">'+padLeadingZeros(minutes, 2)+':</span><span class="countdowns text-white bg-danger  justify-content-center align-items-center fs-18">'+padLeadingZeros(seconds, 2)+'</span></div></a>';
