                ...
                <div class="panel-body">
                    ...
                    @endif
                     ...
                     <form role="form" action="{{ route('stripe.post') }}" method="post" class="require-validation"
                        ...
                        <input type="hidden" name="price" value="{{ $booking->meeting_price }}">

                        <div class='form-row row'>

                            <div class='col-xs-12 form-group required'> 

                                <label class='control-label roboto'>Name on Card</label> 
                                <input class='form-control payment-input roboto' size='4' type='text' placeholder="Full Name">
                        ...
                        <div class='form-row row'>
                            ...
                            <div class='col-xs-12 form-group card required'>
                                ...
                                <label class='control-label roboto'>Card Number</label> 
                                
                                <input autocomplete='off' class='form-control card-number payment-input roboto' size='20'
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-xs-12">
                                ...
                                <button class="btn btn-primary btn-lg btn-block text-capitalize d-block button-primary fs-14 roboto" style="border: 0;" type="submit">Pay Now ({{ $booking->meeting_price }})</button>
